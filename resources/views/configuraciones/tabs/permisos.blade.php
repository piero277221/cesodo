                        ...
                        <div class="card h-100 border-0 shadow-sm hover-card">
                            <div class="card-header text-white position-relative" style="background: linear-gradient(135deg, #dc3545 0%, #c82333 100%); padding: 1rem;">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h6 class="mb-0 fw-bold">{{ $nombreModulo }}</h6>
                                    </div>
                                    <span class="badge bg-white text-danger">{{ count($permisosModulo) }}</span>
                                </div>
                            </div>
                            <div class="card-body" style="padding: 1.25rem;">
                                ...
                                <div class="form-check mb-3 pb-3 border-bottom d-flex align-items-center" style="background: #f8f9fa; padding: 0.875rem 1rem; border-radius: 6px; margin: -0.25rem -0.25rem 1rem -0.25rem; cursor: pointer; min-height: 55px;">
                                    ...
                                    <label class="form-check-label fw-bold d-flex align-items-center ms-3" for="module_{{ $modulo }}" style="cursor: pointer; user-select: none; margin: 0;">
                                    ...
                                    @foreach($permisosModulo as $permiso)
                                        <div class="form-check mb-2 permission-item d-flex align-items-center" style="padding: 0.75rem 1rem; border-radius: 6px; transition: all 0.2s; cursor: pointer; min-height: 50px;">
                                            <input class="form-check-input permission-checkbox module-permission-{{ $modulo }}"
                                                   ...
                                                   style="cursor: pointer; width: 1.25em; height: 1.25em; margin: 0; flex-shrink: 0;">
                                            <label class="form-check-label d-flex align-items-center ms-3" for="permission_{{ $permiso->id }}" style="cursor: pointer; width: 100%; user-select: none; margin: 0;">
                                                @php
                                                ...
                                                @endphp
                                                <i class="bi bi-{{ $iconoPermiso }} me-2" style="color: {{ $colorAccion }}; font-size: 1.1rem;"></i>
                                                <span class="fw-semibold" style="color: #2d3748;">{{ $nombrePermiso }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
