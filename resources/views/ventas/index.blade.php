                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('ventas.create') }}" class="btn btn-success btn-modern">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-success">${{ number_format(0, 0, ',', '.') }}</h5>
                                    <p class="mb-0">
                                        <span class="text-success text-sm font-weight-bolder">0</span> ventas
                                    </p>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-info">${{ number_format(0, 0, ',', '.') }}</h5>
                                    <p class="mb-0">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.exportVentas = function() {
        ...
        window.location.href = `{{ route('ventas.index') }}?${searchParams.toString()}`;
    };
});
</script>
@endpush
