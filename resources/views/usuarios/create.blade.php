                                            ...
                                            <select name="persona_id" id="persona_id" class="form-select">
                                                ...
                                                @foreach($personas as $persona)
                                                    <option value="{{ $persona->id }}"
                                                            ...
                                                            data-email="{{ $persona->email_sugerido }}"
                                                            data-dni="{{ $persona->numero_documento }}"
                                            ...
                                            <select name="trabajador_id" id="trabajador_id" class="form-select">
                                                ...
                                                @foreach($trabajadores as $trabajador)
                                                    <option value="{{ $trabajador->id }}"
                                                            ...
                                                            data-nombre="{{ $trabajador->persona ? $trabajador->persona->nombre_completo : $trabajador->nombre_completo }}"
                                                            data-persona-id="{{ $trabajador->persona_id }}">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="observaciones" name="observaciones"
                                                      rows="3" placeholder="Notas adicionales sobre el usuario...">{{ old('observaciones') }}</textarea>
                                        </div>
                                    </div>
                                </div>
