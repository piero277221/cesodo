                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold text-cesodo-black">{{ isset($personas) ? (is_object($personas) && method_exists($personas, 'total') ? $personas->total() : count($personas)) : 0 }}</h3>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold text-cesodo-black">{{ isset($stats['con_trabajador']) ? $stats['con_trabajador'] : 0 }}</h3>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold text-cesodo-black">{{ isset($stats['sin_trabajador']) ? $stats['sin_trabajador'] : 0 }}</h3>
                                </div>
                                <div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <h3 class="mb-0 fw-bold text-cesodo-black">{{ isset($stats['nuevas_mes']) ? $stats['nuevas_mes'] : 0 }}</h3>
                                </div>
                                <div>
