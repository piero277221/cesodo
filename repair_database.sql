-- Script SQL para crear las tablas faltantes
USE scm_cesodo;
...
SELECT 'condiciones_salud' as tabla, COUNT(*) as registros FROM condiciones_salud
UNION
SELECT 'menu_condiciones' as tabla, COUNT(*) as registros FROM menu_condiciones
UNION
SELECT 'menu_inventario_usado' as tabla, COUNT(*) as registros FROM menu_inventario_usado;
