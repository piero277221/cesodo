<?php $__env->startSection('title', 'Gestión de Compras'); ?>
                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('compras.create')); ?>" class="btn btn-info btn-modern">
    ...
    <div class="container-fluid py-4">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-info"><?php echo e(\App\Models\Proveedor::count() ?? 0); ?></h5>
                                    <p class="mb-0">
        ...
        <div class="card card-modern">
            ...
            <div class="card-header border-0 pb-0">
                <div class="row">
                    <div class="col-12">
                        <form method="GET" action="<?php echo e(route('compras.index')); ?>" class="filter-form">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="estado" class="form-select">
                                        ...
                                        <option value="recibida" <?php echo e(request('estado') == 'recibida' ? 'selected' : ''); ?>>Recibida</option>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.exportCompras = function() {
        ...
        window.location.href = `<?php echo e(route('compras.index')); ?>?${searchParams.toString()}`;
    };
});
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/compras/index.blade.php ENDPATH**/ ?>