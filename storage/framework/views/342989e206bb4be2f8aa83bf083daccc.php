<?php $__env->startSection('title', 'Recuperar Contraseña - CESODO'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none text-primary">
                            <i class="fas fa-arrow-left me-1"></i>
                            Volver al Login
                        </a>

                        <a href="<?php echo e(route('register')); ?>" class="text-decoration-none text-secondary">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>