...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'Laravel')); ?> - <?php echo $__env->yieldContent('title', 'Sistema SCM'); ?></title>
        ...
        <!-- CESODO Theme - Sistema de Diseño Principal -->
        <link href="<?php echo e(asset('css/cesodo-theme.css')); ?>" rel="stylesheet">

        <!-- Modern Styles -->
        <link href="<?php echo e(asset('css/modern-styles.css')); ?>" rel="stylesheet">
        <!-- Navigation Styles -->
        <link href="<?php echo e(asset('css/navigation-new.css')); ?>" rel="stylesheet">
        <!-- Whitespace Fix -->
        <link href="<?php echo e(asset('css/whitespace-fix.css')); ?>" rel="stylesheet">
        <!-- Remove Blur Effects -->
        <link href="<?php echo e(asset('css/no-effects.css')); ?>" rel="stylesheet">
    ...
    <body class="font-sans antialiased">
        ...
        <script src="<?php echo e(asset('js/modern-ui.js')); ?>"></script>

        <?php echo $__env->yieldPushContent('scripts'); ?>
    </body>
</html>
<?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/layouts/app.blade.php ENDPATH**/ ?>