                ...
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('clientes.create')); ?>" class="btn btn-primary btn-modern">
    ...
    <div class="container-fluid py-4">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder"><?php echo e($clientes->total() ?? 0); ?></h5>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-success"><?php echo e($clientes->where('estado', 'activo')->count() ?? 0); ?></h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-info"><?php echo e($clientes->where('created_at', '>=', now()->startOfMonth())->count() ?? 0); ?></h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <h5 class="font-weight-bolder text-warning">$<?php echo e(number_format(0, 0, ',', '.')); ?></h5>
                                </div>
                            </div>
                            <div class="col-4 text-end">
        ...
        <div class="card card-modern">
            ...
            <div class="card-header border-0 pb-0">
                <div class="row">
                    <div class="col-12">
                        <form method="GET" action="<?php echo e(route('clientes.index')); ?>" class="filter-form">
                    ...
                    <table class="table table-modern align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex px-2 py-1 align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm font-weight-bold"><?php echo e($cliente->nombre); ?></h6>
                                            <?php if($cliente->rut): ?>
                                                <p class="text-xs text-secondary mb-0">
                                                    <i class="bi bi-person-vcard me-1"></i><?php echo e($cliente->rut); ?>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <?php if($cliente->email): ?>
                                            <p class="text-sm mb-0">
                                                <i class="bi bi-envelope me-1 text-primary"></i><?php echo e($cliente->email); ?>

                                            </p>
                                        <?php endif; ?>
                                        <?php if($cliente->telefono): ?>
                                            <p class="text-xs text-secondary mb-0">
                                                <i class="bi bi-telephone me-1"></i><?php echo e($cliente->telefono); ?>
                                ...
                                <td>
                                    <span class="badge badge-modern <?php echo e($cliente->tipo == 'natural' ? 'bg-info' : 'bg-warning'); ?>">
                                        <i class="bi bi-<?php echo e($cliente->tipo == 'natural' ? 'person' : 'building'); ?> me-1"></i>
                                        <?php echo e($cliente->tipo == 'natural' ? 'Natural' : 'Jurídica'); ?>

                                    </span>
                                </td>
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="text-sm font-weight-bold">$<?php echo e(number_format(0, 0, ',', '.')); ?></span>
                                        <span class="text-xs text-secondary">0 ventas</span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge badge-modern badge-<?php echo e($cliente->estado); ?>">
                                        <i class="bi bi-<?php echo e($cliente->estado == 'activo' ? 'check-circle' : ($cliente->estado == 'inactivo' ? 'x-circle' : 'pause-circle')); ?> me-1"></i>
                        ...
                        <i class="bi bi-trash me-2"></i>Eliminar
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-sm">
                                                <?php echo e($cliente->ventas->first()->total_ventas ?? 0); ?> ventas
                                            </h6>
                                            <p class="text-xs text-secondary mb-0">
                                                Total: $<?php echo e(number_format($cliente->ventas->first()->total_comprado ?? 0, 0, ',', '.')); ?>

                                            </p>
                                        </div>
                                    </td>
                                    <td>
                                        <span class="badge badge-sm bg-gradient-<?php echo e($cliente->estado == 'activo' ? 'success' : ($cliente->estado == 'suspendido' ? 'danger' : 'secondary')); ?>">
                                            <?php echo e(ucfirst($cliente->estado)); ?>
                                    ...
                                    <td class="align-middle">
                                        <div class="dropdown">
                                            <button class="btn btn-link text-secondary mb-0" type="button" id="dropdownMenuButton<?php echo e($cliente->id); ?>" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="fa fa-ellipsis-v text-xs"></i>
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo e($cliente->id); ?>">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('clientes.show', $cliente)); ?>">
                                                        <i class="fas fa-eye me-2"></i>Ver Detalles
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('clientes.edit', $cliente)); ?>">
                                                        <i class="fas fa-edit me-2"></i>Editar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('clientes.estado-cuenta', $cliente)); ?>">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-4">
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <a href="<?php echo e(route('clientes.create')); ?>" class="btn bg-gradient-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.exportClientes = function() {
        ...
        window.location.href = `<?php echo e(route('clientes.index')); ?>?${searchParams.toString()}`;
    };
