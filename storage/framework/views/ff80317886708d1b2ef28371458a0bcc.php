<?php $__env->startSection('title', 'Subir Plantilla de Contrato'); ?>
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?php echo e(route('contratos.templates.index')); ?>" class="btn btn-outline-light btn-sm">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('contratos.templates.store')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control"
                                              ...
                                              name="descripcion"
                                              rows="3"
                                              placeholder="Descripción breve de la plantilla y cuándo usarla..."><?php echo e(old('descripcion')); ?></textarea>
                                </div>
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="<?php echo e(route('contratos.templates.index')); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/contratos/templates/create.blade.php ENDPATH**/ ?>