...
<?php endif; ?>
                            ...
                            <div class="nav-dropdown" id="dropdown-administracion">
                                <button type="button" class="nav-dropdown-trigger <?php echo e(request()->routeIs(['configuraciones.*', 'configurations.*', 'role-management.*', 'dynamic-fields.*', 'contratos.templates.*']) ? 'active' : ''); ?>"
                                ...
                                <div class="nav-dropdown-menu shadow-sm border" style="display: none; min-width: 250px;">
                                    <div class="py-2">
                                        ...
                                        <a href="<?php echo e(route('configuraciones.index')); ?>" class="nav-dropdown-item d-flex align-items-center gap-2 <?php echo e(request()->routeIs('configuraciones.*') ? 'active' : ''); ?>">
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginald69b52d99510f1e7cd3d80070b28ca18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald69b52d99510f1e7cd3d80070b28ca18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.responsive-nav-link','data' => ['href' => route('configuraciones.index'),'active' => request()->routeIs('configuraciones.*')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('responsive-nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('configuraciones.index')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('configuraciones.*'))]); ?>
