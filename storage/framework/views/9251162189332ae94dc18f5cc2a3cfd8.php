<?php $__env->startSection('title', 'Editar Campo Dinámico'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <nav aria-label="breadcrumb" class="mt-2">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('modules.index')); ?>">Módulos</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dynamic-fields.index')); ?>">Campos Dinámicos</a></li>
                    <li class="breadcrumb-item active">Editar Campo</li>
                </ol>
            </nav>
        </div>
        <div>
            <a href="<?php echo e(route('dynamic-fields.index')); ?>" class="btn btn-outline-secondary">
            ...
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        ...
                        Configuración del Campo: <?php echo e($dynamicField->label); ?>

                    </h5>
                </div>

                <form action="<?php echo e(route('dynamic-fields.update', $dynamicField)); ?>" method="POST" id="editFieldForm">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                   id="name"
                                                   name="name"
                                                   value="<?php echo e(old('name', $dynamicField->name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                   id="label"
                                                   name="label"
                                                   value="<?php echo e(old('label', $dynamicField->label)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = ['text' => 'Texto', 'textarea' => 'Área de Texto', 'number' => 'Número', 'email' => 'Email', 'password' => 'Contraseña', 'date' => 'Fecha', 'datetime' => 'Fecha y Hora', 'time' => 'Hora', 'select' => 'Lista Desplegable', 'checkbox' => 'Casilla de Verificación', 'radio' => 'Botones de Radio', 'file' => 'Archivo', 'image' => 'Imagen', 'url' => 'URL', 'tel' => 'Teléfono']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <?php $__currentLoopData = ['trabajadores' => 'Trabajadores', 'clientes' => 'Clientes', 'contratos' => 'Contratos', 'inventario' => 'Inventario', 'compras' => 'Compras', 'pedidos' => 'Pedidos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($value); ?>" <?php echo e(old('module', $dynamicField->module) == $value ? 'selected' : ''); ?>>
                                                        <?php echo e($label); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                  ...
                                                  name="description"
                                                  rows="2"
                                                  placeholder="Descripción opcional del campo"><?php echo e(old('description', $dynamicField->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-section mb-4">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input"
                                                       ...
                                                       <?php echo e(isset(old('validation_rules', $dynamicField->validation_rules ?? [])['required']) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input"
                                                       ...
                                                       <?php echo e(isset(old('validation_rules', $dynamicField->validation_rules ?? [])['unique']) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="row mb-3" id="lengthRules" style="display: none;">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="<?php echo e(old('validation_rules.min_length', $dynamicField->validation_rules['min_length'] ?? '')); ?>"
                                                   min="0">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="<?php echo e(old('validation_rules.max_length', $dynamicField->validation_rules['max_length'] ?? '')); ?>"
                                                   min="1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3" id="numericRules" style="display: none;">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="<?php echo e(old('validation_rules.min_value', $dynamicField->validation_rules['min_value'] ?? '')); ?>"
                                                   step="any">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="<?php echo e(old('validation_rules.max_value', $dynamicField->validation_rules['max_value'] ?? '')); ?>"
                                                   step="any">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3" id="patternRule" style="display: none;">
                                        ...
                                        <input type="text"
                                               ...
                                               value="<?php echo e(old('validation_rules.pattern', $dynamicField->validation_rules['pattern'] ?? '')); ?>"
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="placeholder"
                                                   name="placeholder"
                                                   value="<?php echo e(old('placeholder', $dynamicField->placeholder)); ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="default_value"
                                                   name="default_value"
                                                   value="<?php echo e(old('default_value', $dynamicField->default_value)); ?>">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   id="css_classes"
                                                   name="css_classes"
                                                   value="<?php echo e(old('css_classes', $dynamicField->css_classes)); ?>"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="group_id" name="group_id">
                                                ...
                                                <?php $__currentLoopData = \App\Models\DynamicFieldGroup::orderBy('name')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($group->id); ?>" <?php echo e(old('group_id', $dynamicField->group_id) == $group->id ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input"
                                                   ...
                                                   id="is_active"
                                                   name="is_active"
                                                   <?php echo e(old('is_active', $dynamicField->is_active) ? 'checked' : ''); ?>>
                    ...
                    <div class="card-footer bg-light">
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <a href="<?php echo e(route('dynamic-fields.index')); ?>" class="btn btn-outline-secondary me-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const existingOptions = <?php echo json_encode($dynamicField->options ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/dynamic-fields/edit.blade.php ENDPATH**/ ?>