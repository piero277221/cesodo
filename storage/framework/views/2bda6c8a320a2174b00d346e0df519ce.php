                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-sm mb-0">Actualiza la información del cliente: <?php echo e($cliente->nombre); ?></p>
                        </div>
                        <a href="<?php echo e(route('clientes.show', $cliente)); ?>" class="btn btn-outline-secondary">
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                <option value="natural" <?php echo e(old('tipo', $cliente->tipo) == 'natural' ? 'selected' : ''); ?>>Persona Natural</option>
                                                <option value="juridica" <?php echo e(old('tipo', $cliente->tipo) == 'juridica' ? 'selected' : ''); ?>>Persona Jurídica</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rut" id="rut"
                                                   class="form-control <?php $__errorArgs = ['rut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('rut', $cliente->rut)); ?>" placeholder="12345678-9">
                                            <?php $__errorArgs = ['rut'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group" id="giro-group" style="display: <?php echo e(old('tipo', $cliente->tipo) == 'juridica' ? 'block' : 'none'); ?>;">
                                            <label class="form-control-label" for="giro">Giro/Actividad</label>
                                            <input type="text" name="giro" id="giro"
                                                   class="form-control <?php $__errorArgs = ['giro'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('giro', $cliente->giro)); ?>" placeholder="Ej: Comercio al por menor">
...
unset($__errorArgs, $__bag); ?>" required>
                                                <option value="activo" <?php echo e(old('estado', $cliente->estado) == 'activo' ? 'selected' : ''); ?>>Activo</option>
                                                <option value="inactivo" <?php echo e(old('estado', $cliente->estado) == 'inactivo' ? 'selected' : ''); ?>>Inactivo</option>
                                                <option value="suspendido" <?php echo e(old('estado', $cliente->estado) == 'suspendido' ? 'selected' : ''); ?>>Suspendido</option>
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('email', $cliente->email)); ?>" placeholder="cliente@email.com">
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('telefono', $cliente->telefono)); ?>" placeholder="+56 9 1234 5678">
...
unset($__errorArgs, $__bag); ?>"
                                                      placeholder="Dirección completa"><?php echo e(old('direccion', $cliente->direccion)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                                           value="<?php echo e(old('region', $cliente->region)); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="codigo_postal" id="codigo_postal"
                                                   class="form-control <?php $__errorArgs = ['codigo_postal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('codigo_postal', $cliente->codigo_postal)); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="limite_credito" id="limite_credito"
                                                       class="form-control <?php $__errorArgs = ['limite_credito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                       value="<?php echo e(old('limite_credito', $cliente->limite_credito ?? 0)); ?>" min="0" step="0.01">
                                            </div>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="dias_credito" id="dias_credito"
                                                   class="form-control <?php $__errorArgs = ['dias_credito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                   value="<?php echo e(old('dias_credito', $cliente->dias_credito ?? 30)); ?>" min="0" max="365">
                                            <small class="form-text text-muted">Días máximos para pago de facturas a crédito</small>
                                            <?php $__errorArgs = ['dias_credito'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>"
                                                      placeholder="Cualquier información adicional sobre el cliente..."><?php echo e(old('observaciones', $cliente->observaciones)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/clientes/edit.blade.php ENDPATH**/ ?>