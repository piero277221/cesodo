<?php $__env->startSection('title', 'Nuevo Consumo'); ?>
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="mb-4">
                <div class="bg-green-100 border border-green-400 rounded-lg px-6 py-4 shadow text-center">
                    ...
                    <span class="d-block display-4 fw-bold text-green-700" id="contadorPlatos">
                        <?php echo e($menu->platos_disponibles ?? 0); ?>

                    </span>
                    <span class="d-block text-sm text-gray-600">de <?php echo e($menu->platos_totales ?? 0); ?> totales</span>
                </div>
            </div>
            <div class="card shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="<?php echo e(route('consumos.store')); ?>" method="POST" id="consumoForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="trabajador_id" id="trabajador_id" class="form-select <?php $__errorArgs = ['trabajador_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $trabajadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trabajador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($trabajador->id); ?>"
                                                ...
                                                data-nombres="<?php echo e($trabajador->nombres); ?>"
                                                data-apellidos="<?php echo e($trabajador->apellidos); ?>"
                                                <?php echo e(old('trabajador_id') == $trabajador->id ? 'selected' : ''); ?>>
                                            <?php echo e($trabajador->nombres); ?> <?php echo e($trabajador->apellidos); ?> - <?php echo e($trabajador->codigo); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <?php $__errorArgs = ['trabajador_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                ...
                                <div class="row g-2">
                                    <div class="col-4">
                                        <input type="radio" class="btn-check" name="tipo_comida" id="desayuno" value="desayuno"
                                               <?php echo e(old('tipo_comida') == 'desayuno' ? 'checked' : ''); ?> required>
                                    ...
                                    <div class="col-4">
                                        <input type="radio" class="btn-check" name="tipo_comida" id="almuerzo" value="almuerzo"
                                               <?php echo e(old('tipo_comida') == 'almuerzo' ? 'checked' : ''); ?> required>
                                    ...
                                    <div class="col-4">
                                        <input type="radio" class="btn-check" name="tipo_comida" id="cena" value="cena"
                                               <?php echo e(old('tipo_comida') == 'cena' ? 'checked' : ''); ?> required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date"
                                       name="fecha_consumo"
                                       id="fecha_consumo"
                                       class="form-control <?php $__errorArgs = ['fecha_consumo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                       value="<?php echo e(old('fecha_consumo', date('Y-m-d'))); ?>"
                                       max="<?php echo e(date('Y-m-d')); ?>"
                                       required>
                                <?php $__errorArgs = ['fecha_consumo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time"
                                       name="hora_consumo"
                                       id="hora_consumo"
                                       class="form-control <?php $__errorArgs = ['hora_consumo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/consumos/create_new.blade.php ENDPATH**/ ?>