...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('certificados-medicos.show', $certificadosMedico)); ?>" class="btn btn-outline-primary">
            ...
            <div class="alert alert-info mb-4">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <?php echo e($certificadosMedico->persona->nombre_completo); ?>

                    </div>
                    <div class="col-md-2">
                        <strong>DNI:</strong><br>
                        <?php echo e($certificadosMedico->numero_documento); ?>

                    </div>
                    <div class="col-md-3">
                        <strong>Celular:</strong><br>
                        <?php echo e($certificadosMedico->persona->celular ?? 'No registrado'); ?>

                    </div>
                    <div class="col-md-3">
                        <strong>Correo:</strong><br>
                        <?php echo e($certificadosMedico->persona->correo ?? 'No registrado'); ?>

                    </div>
                </div>
            </div>

            <form method="POST" action="<?php echo e(route('certificados-medicos.update', $certificadosMedico)); ?>"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if($certificadosMedico->archivo_certificado): ?>
                            <div class="alert alert-success">
                                <i class="fas fa-file-pdf me-2"></i>
                                <strong><?php echo e(basename($certificadosMedico->archivo_certificado)); ?></strong>
                                <a href="<?php echo e(route('certificados-medicos.descargar', $certificadosMedico)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                               id="fecha_emision"
                               name="fecha_emision"
                               value="<?php echo e(old('fecha_emision', $certificadosMedico->fecha_emision?->format('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               value="<?php echo e(old('fecha_expiracion', $certificadosMedico->fecha_expiracion?->format('Y-m-d'))); ?>"
                               required>
...
unset($__errorArgs, $__bag); ?>"
                                  ...
                                  rows="3"
                                  maxlength="1000"
                                  placeholder="Observaciones adicionales sobre el certificado médico"><?php echo e(old('observaciones', $certificadosMedico->observaciones)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/certificados-medicos/edit.blade.php ENDPATH**/ ?>