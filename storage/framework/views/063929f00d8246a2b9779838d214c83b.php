...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
            ...
            <div class="row align-items-center">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a href="<?php echo e(route('compras.index')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="container-fluid py-4">
        <form action="<?php echo e(route('compras.store')); ?>" method="POST" id="compraForm">
            <?php echo csrf_field(); ?>
            <div class="row">
                <!-- Información básica -->
                <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                           class="form-control <?php $__errorArgs = ['numero_compra'];
...
unset($__errorArgs, $__bag); ?>"
                                           id="numero_compra"
                                           name="numero_compra"
                                           value="<?php echo e(old('numero_compra', 'COM-' . date('Y') . '-' . str_pad(rand(1, 9999), 4, '0', STR_PAD_LEFT))); ?>"
                                           required>
                                    <?php $__errorArgs = ['numero_compra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date"
                                           class="form-control <?php $__errorArgs = ['fecha_compra'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           id="fecha_compra"
                                           name="fecha_compra"
                                           value="<?php echo e(old('fecha_compra', date('Y-m-d'))); ?>"
                                           required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select <?php $__errorArgs = ['tipo_comprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="factura" <?php echo e(old('tipo_comprobante') == 'factura' ? 'selected' : ''); ?>>Factura</option>
                                        <option value="boleta" <?php echo e(old('tipo_comprobante') == 'boleta' ? 'selected' : ''); ?>>Boleta</option>
                                        <option value="ticket" <?php echo e(old('tipo_comprobante') == 'ticket' ? 'selected' : ''); ?>>Ticket</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text"
                                           class="form-control <?php $__errorArgs = ['numero_comprobante'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                           ...
                                           value="<?php echo e(old('numero_comprobante')); ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="input-group input-group-sm">
                                    <input type="number"
                                           ...
                                           id="descuento"
                                           name="descuento"
                                           value="<?php echo e(old('descuento', 0)); ?>"
                                           min="0"
                                           step="0.01"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="estado" name="estado">
                                    ...
                                    <option value="enviado" <?php echo e(old('estado') == 'enviado' ? 'selected' : ''); ?>>Enviado</option>
                                    <option value="recibido" <?php echo e(old('estado') == 'recibido' ? 'selected' : ''); ?>>Recibido</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="metodo_pago" name="metodo_pago">
                                    ...
                                    <option value="credito" <?php echo e(old('metodo_pago') == 'credito' ? 'selected' : ''); ?>>Crédito</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 mb-2">
                ...
                <select class="form-select producto-select" name="productos[][producto_id]" required>
                    ...
                    <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($producto->id); ?>" data-precio="<?php echo e($producto->precio_compra ?? $producto->precio_venta); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cesodo4\resources\views/compras/create.blade.php ENDPATH**/ ?>